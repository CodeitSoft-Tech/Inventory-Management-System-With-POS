          <div class="main-navbar hor-menu sticky">
				<div class="container">
					<ul class="nav">
						<li class="nav-item">
							<a class="nav-link" href="index.php"><i class="ti-home"></i>Dashboard</a>
						</li>
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								...
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="expenses.php">Expenses</a>
								</li>
								<li class="nav-sub-item">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href=""><i class="ti-write"></i>History Log</a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="history-log.php">Admin Log</a>
								</li>
								<li class="nav-sub-item">
						...
						<li class="nav-item">
							<a class="nav-link with-sub" href=""><i class="ti-user"></i> Staffs </a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="manage-user.php">Administrators</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="employees.php">Employees</a>
								</li>
							</ul>
						</li>

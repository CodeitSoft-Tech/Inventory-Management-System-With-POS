           ...
           <!-- Main Content-->
				...
				<div class="container">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Manage Employees</h2>
								<ol class="breadcrumb">
						...
						<div class="row sidemenu-height">
							<div class="col-lg-12">
								<div class="card custom-card">
									<div class="card-body">
										<a href="#add" data-target="#add" data-toggle="modal" class="btn btn-primary">Add New Employee</a><hr class="mb-4">
										<table class="table" id="example1">
												...
												<tbody>
													<?php
														...
														$select_ad = "SELECT * FROM tbl_employees";
			...
			<div class="modal" id="delete<?php echo $admin_id;?>">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Delete Employee Details</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
							<form action="employee-del.php" method="post">
								 <input type="hidden" class="form-control" name="admin_id" value="<?php echo $admin_id; ?>" required> 
                      
                                  <p>Are you sure you want to <b>Delete</b> this Employee?</p>
			...
			<div class="modal" id="add">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Employee Details</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">

				...
				<div class="container">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Attendant Dashboard</h2>
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.php">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Attendant Dashboard</li>
								</ol>
							</div>
						</div>
						<!-- End Page Header -->
									...
									<div class="row row-sm">
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0">
											<div class="card-body text-center">
												...
												<h2 class="mb-1 mt-2 number-font"><span class="counter"><?php echo ShowProduct()  ?></span></h2>
											</div>
										</div>
						...
						<table class="table  text-nowrap text-md-nowrap table-striped mg-b-0">
							...
							<tbody>
								<?php  
							     ...
							     $i = 0;
							     $product_stop = 10;
							     $select_latest = "SELECT * FROM product_tbl WHERE prod_qty <= reorder";
							     $run_latest    = mysqli_query($db, $select_latest);
							                        
							     while($row_latest = mysqli_fetch_array($run_latest))
							     {

							       $prod_id      = $row_latest['prod_id'];
							       $prod_name    = $row_latest['prod_name']; 
							       $prod_qty     = $row_latest['prod_qty'];

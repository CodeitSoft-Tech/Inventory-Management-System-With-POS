						...
						<div class="page-header btn-print">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Warehouse Report By Attendant</li>
								</ol>
							</div>
						</div>
						<!-- End Page Header -->
								...
								<div class="card custom-card">
									...
									<div class="card-body">
										 ...
										 <?php     
						                  ...
						                  <h6 style="font-size: 20px; text-align: center; color: #6259CA;">
						                   ...
						                   <h5 style="font-size: 20px; text-align: center; color: #6259CA; margin-bottom: 20px; ">
								            <b>
								              Warehouse Report as of <?php echo date("M d, Y",strtotime($start))." to ".date("M d, Y",strtotime($end));?> by <?php echo $emp_name; ?> 
								            </b>
								          </h5>
								          <hr>
						              ...
						              <th colspan="9">OverAll Total</th>     						  
							                 ...
							                 $query = mysqli_query($db,"SELECT * FROM tbl_warehse_prod_moved WHERE date(date_moved)>='$start' AND date(date_moved)<='$end' AND emp_id = '$admin_id' ORDER BY date_moved")or die(mysqli_error($db));

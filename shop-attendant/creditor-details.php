											...
											<div class="col-md-12 col-lg-12 col-xl-12">
												<div class="">
													<?php 
														...
														$sel_emp = "SELECT * FROM tbl_employees WHERE emp_username = '$username'";
														$run_emp = mysqli_query($db, $sel_emp);
													...
													<div class="form-group col-md-9">
														<input class="form-control" required="" name="emp_id" value="<?php echo $emp_id; ?>" type="hidden">
													</div>
												...
												<tbody>
													<?php 
													  ...
													  $username = $_SESSION['emp_username'];
														...
														$i = 0;
														$get_cred = "SELECT * FROM tbl_creditors WHERE emp_id = '$emp_id'";

											...
											<div class="col-md-12 col-lg-12 col-xl-12">
												<div class="">
													...
													<div class="form-group col-md-9">
														<input class="form-control" required="" name="admin_id" value="<?php echo $admin_id; ?>" type="hidden">
													</div>
										...
										<div class="col-md-6">
											...
											<table class="table" id="example1">
												...
												<tbody>
													...
													$i = 0;
													$get_cat = "SELECT * FROM tbl_expenses WHERE emp_id = '$admin_id'";
													$run_cat = mysqli_query($db, $get_cat);
													...
													while($row_cat  = mysqli_fetch_array($run_cat))
													{
														...
														$expense_amt	= $row_cat['expense_amount'];
														$expense_date	= $row_cat['expense_date'];
